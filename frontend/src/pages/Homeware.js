...
const Homeware = () => {
    ...
    const fetchProducts = async () => {
        try {
            setLoading(true);
            const data = await getProductsByCategory('Homeware');
            setProducts(data);
        } catch (error) {
                ...
                <Container maxWidth="xl">
                    ...
                    >
                        ...
                        <Typography variant="body1" color="text.secondary" paragraph>
                            Upgrade your living space with our range of home electronic appliances, designed for convenience, efficiency, and modern comfort.
                        </Typography>
                    ...
                    <Paper elevation={0} sx={{ p: 2, mb: 3, borderRadius: 3, border: '1px solid', borderColor: 'divider' }}>
                        <Grid container spacing={2} alignItems="center">
                            <Grid item xs={12} md={8}>
                                <SearchBar onSearch={handleSearch} placeholder="Search small appliances..." />
                            </Grid>
