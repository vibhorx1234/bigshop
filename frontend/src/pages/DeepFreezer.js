...
const DeepFreezer = () => {
    ...
    const fetchProducts = async () => {
        try {
            setLoading(true);
            const data = await getProductsByCategory('Deep Freezer');
            setProducts(data);
        } catch (error) {
    ...
    if (loading) {
        return <Loader message="Loading Deep Freezers..." />;
    }
                ...
                <Container maxWidth="xl">
                    ...
                    >
                        <Typography variant="h3" component="h1" gutterBottom fontWeight={700}>
                            Voltas Deep Freezers
                        </Typography>
                        <Typography variant="body1" color="text.secondary" paragraph>
                            Explore our wide range of energy-efficient deep freezers for home and commercial use
                        </Typography>
                    ...
                    <Paper elevation={0} sx={{ p: 2, mb: 3, borderRadius: 3, border: '1px solid', borderColor: 'divider' }}>
                        <Grid container spacing={2} alignItems="center">
                            <Grid item xs={12} md={8}>
                                <SearchBar onSearch={handleSearch} placeholder="Search Deep Freezers..." />
                            </Grid>
