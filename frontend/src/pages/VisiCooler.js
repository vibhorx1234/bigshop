...
const VisiCooler = () => {
    ...
    const fetchProducts = async () => {
        try {
            setLoading(true);
            const data = await getProductsByCategory('Visi Cooler');
            setProducts(data);
        } catch (error) {
    ...
    if (loading) {
        return <Loader message="Loading Visi Coolers..." />;
    }
                ...
                <Container maxWidth="xl">
                    ...
                    >
                        ...
                        <Typography variant="body1" color="text.secondary" paragraph>
                            Discover our sleek and efficient Visi Coolers, perfect for keeping beverages and essentials chilled
                        </Typography>
                    ...
                    <Paper elevation={0} sx={{ p: 2, mb: 3, borderRadius: 3, border: '1px solid', borderColor: 'divider' }}>
                        <Grid container spacing={2} alignItems="center">
                            <Grid item xs={12} md={8}>
                                <SearchBar onSearch={handleSearch} placeholder="Search Visi Coolers..." />
                            </Grid>
